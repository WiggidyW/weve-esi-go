...
var file_weve_esi_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x73, 0x69, 0x6e, 0x63, 0x65, 0x32,
	0xf5, 0x04, 0x0a, 0x07, 0x57, 0x65, 0x76, 0x65, 0x45, 0x73, 0x69, 0x12, 0x50, 0x0a, 0x0c, 0x41,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x70, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_weve_esi_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_weve_esi_proto_goTypes = []interface{}{
	...
	nil,                          // 30: weve_esi_proto.AdjustedPriceRep.InnerEntry
	nil,                          // 31: weve_esi_proto.SystemIndexRep.InnerEntry
	nil,                          // 32: weve_esi_proto.LocationAssets.InnerEntry
	nil,                          // 33: weve_esi_proto.AssetsRep.InnerEntry
	nil,                          // 34: weve_esi_proto.Skills.InnerEntry
	nil,                          // 35: weve_esi_proto.SkillsRep.InnerEntry
	nil,                          // 36: weve_esi_proto.LocationActiveOrders.InnerEntry
	nil,                          // 37: weve_esi_proto.ActiveOrdersRep.InnerEntry
	nil,                          // 38: weve_esi_proto.LocationTransactions.InnerEntry
	nil,                          // 39: weve_esi_proto.TransactionsRep.InnerEntry
}
var file_weve_esi_proto_depIdxs = []int32{
	1,  // 0: weve_esi_proto.MarketOrdersRep.inner:type_name -> weve_esi_proto.MarketOrder
	30, // 1: weve_esi_proto.AdjustedPriceRep.inner:type_name -> weve_esi_proto.AdjustedPriceRep.InnerEntry
	31, // 2: weve_esi_proto.SystemIndexRep.inner:type_name -> weve_esi_proto.SystemIndexRep.InnerEntry
	...
	32, // 7: weve_esi_proto.LocationAssets.inner:type_name -> weve_esi_proto.LocationAssets.InnerEntry
	33, // 8: weve_esi_proto.AssetsRep.inner:type_name -> weve_esi_proto.AssetsRep.InnerEntry
	...
	34, // 11: weve_esi_proto.Skills.inner:type_name -> weve_esi_proto.Skills.InnerEntry
	35, // 12: weve_esi_proto.SkillsRep.inner:type_name -> weve_esi_proto.SkillsRep.InnerEntry
	...
	36, // 15: weve_esi_proto.LocationActiveOrders.inner:type_name -> weve_esi_proto.LocationActiveOrders.InnerEntry
	37, // 16: weve_esi_proto.ActiveOrdersRep.inner:type_name -> weve_esi_proto.ActiveOrdersRep.InnerEntry
	...
	38, // 20: weve_esi_proto.LocationTransactions.inner:type_name -> weve_esi_proto.LocationTransactions.InnerEntry
	39, // 21: weve_esi_proto.TransactionsRep.inner:type_name -> weve_esi_proto.TransactionsRep.InnerEntry
	...
	6,  // 24: weve_esi_proto.SystemIndexRep.InnerEntry.value:type_name -> weve_esi_proto.SystemIndex
	13, // 25: weve_esi_proto.LocationAssets.InnerEntry.value:type_name -> weve_esi_proto.TypeAssets
	14, // 26: weve_esi_proto.AssetsRep.InnerEntry.value:type_name -> weve_esi_proto.LocationAssets
	17, // 27: weve_esi_proto.SkillsRep.InnerEntry.value:type_name -> weve_esi_proto.Skills
	21, // 28: weve_esi_proto.LocationActiveOrders.InnerEntry.value:type_name -> weve_esi_proto.TypeActiveOrders
	22, // 29: weve_esi_proto.ActiveOrdersRep.InnerEntry.value:type_name -> weve_esi_proto.LocationActiveOrders
	26, // 30: weve_esi_proto.LocationTransactions.InnerEntry.value:type_name -> weve_esi_proto.TypeTransactions
	27, // 31: weve_esi_proto.TransactionsRep.InnerEntry.value:type_name -> weve_esi_proto.LocationTransactions
	24, // 32: weve_esi_proto.WeveEsi.ActiveOrders:input_type -> weve_esi_proto.ActiveOrdersReq
	5,  // 33: weve_esi_proto.WeveEsi.AdjustedPrice:input_type -> weve_esi_proto.AdjustedPriceReq
	16, // 34: weve_esi_proto.WeveEsi.Assets:input_type -> weve_esi_proto.AssetsReq
	11, // 35: weve_esi_proto.WeveEsi.IndustryJobs:input_type -> weve_esi_proto.IndustryJobsReq
	3,  // 36: weve_esi_proto.WeveEsi.MarketOrders:input_type -> weve_esi_proto.MarketOrdersReq
	19, // 37: weve_esi_proto.WeveEsi.Skills:input_type -> weve_esi_proto.SkillsReq
	8,  // 38: weve_esi_proto.WeveEsi.SystemIndex:input_type -> weve_esi_proto.SystemIndexReq
	29, // 39: weve_esi_proto.WeveEsi.Transactions:input_type -> weve_esi_proto.TransactionsReq
	23, // 40: weve_esi_proto.WeveEsi.ActiveOrders:output_type -> weve_esi_proto.ActiveOrdersRep
	4,  // 41: weve_esi_proto.WeveEsi.AdjustedPrice:output_type -> weve_esi_proto.AdjustedPriceRep
	15, // 42: weve_esi_proto.WeveEsi.Assets:output_type -> weve_esi_proto.AssetsRep
	10, // 43: weve_esi_proto.WeveEsi.IndustryJobs:output_type -> weve_esi_proto.IndustryJobsRep
	2,  // 44: weve_esi_proto.WeveEsi.MarketOrders:output_type -> weve_esi_proto.MarketOrdersRep
	18, // 45: weve_esi_proto.WeveEsi.Skills:output_type -> weve_esi_proto.SkillsRep
	7,  // 46: weve_esi_proto.WeveEsi.SystemIndex:output_type -> weve_esi_proto.SystemIndexRep
	28, // 47: weve_esi_proto.WeveEsi.Transactions:output_type -> weve_esi_proto.TransactionsRep
